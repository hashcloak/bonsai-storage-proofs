...
/// @notice Deployment script for the StorageProofChecker project.
...
contract Deploy is Script, BonsaiCheats, BonsaiDeploy {
    function run() external {
        ...
        bytes32 imageId = queryImageId("STORAGE_PROOF");
        console2.log("Image ID for STORAGE_PROOF is ", vm.toString(imageId));
        StorageProofChecker app = new StorageProofChecker(bonsaiRelay, imageId);
        console2.log("Deployed StorageProofChecker to ", address(app));
